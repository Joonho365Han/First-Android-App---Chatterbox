...
public class SignUp extends Activity implements View.OnClickListener
{
    ...
    private static final String TAG_DEBUG = SignUp.class.getName();
	...
	*/
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        et3 = (EditText) findViewById(R.id.signUp_email_input);
        et4 = (EditText) findViewById(R.id.signUp_password_input);
        et5 = (EditText) findViewById(R.id.signUp_nickname_input);

        //The button has parameters corresponding to its ID in the signUp.xml
        createNewUser = (Button) findViewById(R.id.signUp_signUp);
    ...
    public void onClick(View v)
    {
        ...
        if(text.equals(""))
        {
            ...
            Toast.makeText(SignUp.this, getResources().getString(R.string.error_et), Toast.LENGTH_LONG).show();
    ...
    private void launchResultActivity(double total, double tipPercent)
    {
        ...
        Intent resultActivity = new Intent(SignUp.this, Confirm.class);
